...
const prepareEnvironment = () => {
    if (fs.existsSync(outPutFolder)) {
        // Verifica si la carpeta de salida ya existe
    ...
    list.forEach((element) => {
        ...
        if (fs.existsSync(assetFolder)) {
            ...
            archivosAssets.forEach((archivo) => {
                ...
                console.log(`Archivo ${archivo} copiado con éxito`); // Muestra un mensaje de éxito en la consola
            });
        } else {
...
const createHtmlEmailsFiles = (list) => {
    ...
    rl.question("link del header: ", (nombre) => {
        let linkHeader = nombre;
